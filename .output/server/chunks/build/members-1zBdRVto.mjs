  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderList(unref(filteredMembers), (member) => {
        ...
        if (unref(expandedMemberId) === member.id) {
          ...
          if (getMemberUnpaidRecords(member.id).length > 0) {
            ...
            _push(`<div class="py-4 text-center text-gray-500 italic text-sm"> No outstanding payments. All caught up! \u{1F389} </div>`);
          }
          _push(`</div></div>`);
        } else {
          _push(`<!---->`);
      ...
      if (unref(filteredMembers).length === 0) {
        _push(`<div class="p-12 text-center text-gray-500"><p class="text-4xl mb-4">\u{1F465}</p>`);
...
//# sourceMappingURL=members-1zBdRVto.mjs.map
