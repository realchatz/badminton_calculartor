    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<span class="text-2xl mb-2 group-hover:scale-110 transition-transform"${_scopeId}>\u{1F3F8}</span><span class="text-sm font-bold text-gray-700"${_scopeId}>Add Tube</span>`);
          } else {
            return [
              createVNode("span", { class: "text-2xl mb-2 group-hover:scale-110 transition-transform" }, "\u{1F3F8}"),
      ...
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<span class="text-2xl mb-2 group-hover:scale-110 transition-transform"${_scopeId}>\u{1F465}</span><span class="text-sm font-bold text-gray-700"${_scopeId}>Add Member</span>`);
          } else {
            return [
              createVNode("span", { class: "text-2xl mb-2 group-hover:scale-110 transition-transform" }, "\u{1F465}"),
...
//# sourceMappingURL=index-B30aO428.mjs.map
