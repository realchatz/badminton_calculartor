...
export default {
  "node_modules/nuxt/dist/app/entry.js": () => import('./_nuxt/entry-styles.C0lqBlA_.mjs').then(interopDefault),
  "app.vue": () => import('./_nuxt/app-styles.DMGd1bDl.mjs').then(interopDefault),
