...
import { klona } from 'file://D:/badminton_calculator/badminton-fee-app/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file://D:/badminton_calculator/badminton-fee-app/node_modules/defu/dist/defu.mjs';
import destr, { destr as destr$1 } from 'file://D:/badminton_calculator/badminton-fee-app/node_modules/destr/dist/index.mjs';
import { snakeCase } from 'file://D:/badminton_calculator/badminton-fee-app/node_modules/scule/dist/index.mjs';
import { createHead as createHead$1, propsToString, renderSSRHead } from 'file://D:/badminton_calculator/badminton-fee-app/node_modules/unhead/dist/server.mjs';
import { stringify, uneval } from 'file://D:/badminton_calculator/badminton-fee-app/node_modules/devalue/index.js';
import { isVNode, isRef, toValue } from 'file://D:/badminton_calculator/badminton-fee-app/node_modules/vue/index.mjs';
import { DeprecationsPlugin, PromisesPlugin, TemplateParamsPlugin, AliasSortingPlugin } from 'file://D:/badminton_calculator/badminton-fee-app/node_modules/unhead/dist/plugins.mjs';
import { createHooks } from 'file://D:/badminton_calculator/badminton-fee-app/node_modules/hookable/dist/index.mjs';
import { createFetch, Headers as Headers$1 } from 'file://D:/badminton_calculator/badminton-fee-app/node_modules/ofetch/dist/node.mjs';
import { fetchNodeRequestHandler, callNodeRequestHandler } from 'file://D:/badminton_calculator/badminton-fee-app/node_modules/node-mock-http/dist/index.mjs';
import { createStorage, prefixStorage } from 'file://D:/badminton_calculator/badminton-fee-app/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file://D:/badminton_calculator/badminton-fee-app/node_modules/unstorage/drivers/fs.mjs';
import file_58_47_47_47D_58_47badminton_calculator_47badminton_45fee_45app_47node_modules_47_64nuxt_47nitro_45server_47dist_47runtime_47utils_47cache_45driver_46js from 'file://D:/badminton_calculator/badminton-fee-app/node_modules/@nuxt/nitro-server/dist/runtime/utils/cache-driver.js';
import { digest, hash as hash$1 } from 'file://D:/badminton_calculator/badminton-fee-app/node_modules/ohash/dist/index.mjs';
import { toRouteMatcher, createRouter } from 'file://D:/badminton_calculator/badminton-fee-app/node_modules/radix3/dist/index.mjs';
import { readFile } from 'node:fs/promises';
import consola, { consola as consola$1 } from 'file://D:/badminton_calculator/badminton-fee-app/node_modules/consola/dist/index.mjs';
import { ErrorParser } from 'file://D:/badminton_calculator/badminton-fee-app/node_modules/youch-core/build/index.js';
import { Youch } from 'file://D:/badminton_calculator/badminton-fee-app/node_modules/youch/build/index.js';
import { SourceMapConsumer } from 'file://D:/badminton_calculator/badminton-fee-app/node_modules/source-map/source-map.js';
...
import { dirname as dirname$1, resolve as resolve$1 } from 'file://D:/badminton_calculator/badminton-fee-app/node_modules/pathe/dist/index.mjs';
import { walkResolver } from 'file://D:/badminton_calculator/badminton-fee-app/node_modules/unhead/dist/utils.mjs';

const serverAssets = [{"baseName":"server","dir":"D:/badminton_calculator/badminton-fee-app/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"D:/badminton_calculator/badminton-fee-app","watchOptions":{"ignored":[null]}}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"D:/badminton_calculator/badminton-fee-app/server","watchOptions":{"ignored":[null]}}));
storage.mount('cache:nuxt:payload', file_58_47_47_47D_58_47badminton_calculator_47badminton_45fee_45app_47node_modules_47_64nuxt_47nitro_45server_47dist_47runtime_47utils_47cache_45driver_46js({"driver":"file:///D:/badminton_calculator/badminton-fee-app/node_modules/@nuxt/nitro-server/dist/runtime/utils/cache-driver.js","base":"D:/badminton_calculator/badminton-fee-app/.nuxt/cache/nuxt/payload"}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"D:/badminton_calculator/badminton-fee-app/.nuxt"}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"D:/badminton_calculator/badminton-fee-app/.nuxt/cache"}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"D:/badminton_calculator/badminton-fee-app/.data/kv"}));
...
const _ONo_CeM8j0qy3NOeIfuPGPwFQi3YrenZTjudRc8HJU0 = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script}<\/script>`);
  });
});

const rootDir = "D:/badminton_calculator/badminton-fee-app";
...
const _bpLRqhWVFU2ZOvwS2MzRPv6HMhE5lKvpoO0GPBJ43v8 = (nitroApp) => {
...
const _rPBJMq = eventHandler((event) => {
...
const _lazy_BBhITi = () => Promise.resolve().then(function () { return addPlayer_post$1; });
const _lazy_oJbxeA = () => Promise.resolve().then(function () { return removePlayer_post$1; });
const _lazy_xWD5mq = () => Promise.resolve().then(function () { return togglePayment_post$1; });
const _lazy_fR9Oc5 = () => Promise.resolve().then(function () { return updateFee_post$1; });
const _lazy_OWXhXH = () => Promise.resolve().then(function () { return tubes_delete$1; });
const _lazy_BAWimC = () => Promise.resolve().then(function () { return tubes_get$1; });
const _lazy_I9KWxg = () => Promise.resolve().then(function () { return tubes_post$1; });
const _lazy_92Ctme = () => Promise.resolve().then(function () { return renderer; });
...
const handlers = [
  ...
  { route: '/api/shuttlecock/add-player', handler: _lazy_BBhITi, lazy: true, middleware: false, method: "post" },
  { route: '/api/shuttlecock/remove-player', handler: _lazy_oJbxeA, lazy: true, middleware: false, method: "post" },
  { route: '/api/shuttlecock/toggle-payment', handler: _lazy_xWD5mq, lazy: true, middleware: false, method: "post" },
  { route: '/api/shuttlecock/update-fee', handler: _lazy_fR9Oc5, lazy: true, middleware: false, method: "post" },
  { route: '/api/tubes', handler: _lazy_OWXhXH, lazy: true, middleware: false, method: "delete" },
  { route: '/api/tubes', handler: _lazy_BAWimC, lazy: true, middleware: false, method: "get" },
  { route: '/api/tubes', handler: _lazy_I9KWxg, lazy: true, middleware: false, method: "post" },
  { route: '/__nuxt_error', handler: _lazy_92Ctme, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: handler$1, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_92Ctme, lazy: true, middleware: false, method: undefined }
];
...
const members_delete$1 = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
  default: members_delete
}, Symbol.toStringTag, { value: 'Module' }));
...
const addPlayer_post$1 = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
  default: addPlayer_post
}, Symbol.toStringTag, { value: 'Module' }));
...
const removePlayer_post$1 = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
  default: removePlayer_post
}, Symbol.toStringTag, { value: 'Module' }));
...
const togglePayment_post$1 = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
  default: togglePayment_post
}, Symbol.toStringTag, { value: 'Module' }));
...
const updateFee_post$1 = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
  default: updateFee_post
}, Symbol.toStringTag, { value: 'Module' }));
...
const tubes_delete$1 = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
  default: tubes_delete
}, Symbol.toStringTag, { value: 'Module' }));
...
const tubes_get$1 = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
  default: tubes_get
}, Symbol.toStringTag, { value: 'Module' }));
...
const tubes_post$1 = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
  default: tubes_post
}, Symbol.toStringTag, { value: 'Module' }));
